...
var CommonConfig, OfficialGalleryConstants, officialGalleryApp;
...
officialGalleryApp.controller('eventGalleryCtrl', function($scope, $http, $location, officialGalleryService) {
  ...
  return appendResultToPhotos = function(data) {
    return $scope.photos = officialGalleryService.transformToGalleryEntities(data);
  };
});

officialGalleryApp.controller('teamGalleryCtrl', function($scope, $http, $location, officialGalleryService) {
  var appendResultToPhotos;
  $scope.photos = [];
  $scope.config = CommonConfig;
  $scope.config.maxResult = 5;
