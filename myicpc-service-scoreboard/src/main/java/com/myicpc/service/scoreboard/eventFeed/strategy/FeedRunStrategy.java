...
public abstract class FeedRunStrategy {
    ...
    public TeamProblem executeTeamProblem(TeamProblem teamProblem, Contest contest, EventFeedSettingsDTO eventFeedSettings) throws EventFeedException {
        ...
        LastTeamProblem lastTeamProblem = null;
        ...
        if (SUBMISSION_FRESH.equalsIgnoreCase(teamProblem.getStatus())) {
            ...
            lastTeamProblem = changeLastSubmissionByTeam(teamProblem);
        ...
        if (lastTeamProblem != null) {
            onSubmission(lastTeamProblem.getTeamProblem(), teamsToBroadcast);
        }
        return teamProblem;
    }
     ...
     */
    protected LastTeamProblem changeLastSubmissionByTeam(final TeamProblem teamProblem) {
        ...
        return lastTeamProblemRepository.save(lastTeamProblem);
    }
